...
const Promotion = sequelize.define('promotion', {
  ...
  percentage: {type:Sequelize.DECIMAL,allowNull:false, validate: {notNull: true}},
  enddate: {type:Sequelize.INTEGER, allowNull:false,field: 'end_date',validate: {notNull: true}},
  sucursalId: {
